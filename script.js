...
class Cycling extends Workout{
    ...
    type = 'cycling';
    constructor(coords,duration,distance,eleGain){
        super(coords,distance,duration);
...
class App{
    ...
    constructor(){
        ...
        //changing to elevation gain when cycling is selected;
    ...
    _getposition(){
        ...
        alert('Could Not Find your Location; Request Denied')
    })
    }
    ...
    _newWorkout(e){
        ...
        // If workout running, create running marker
        if(type == 'running'){
            ...
            ) return alert('number should be more than 0')

            workout = new Running([lat,lng], distance, duration, cadence);
            
        }

        //If cycling, create cycling marker
        if(type == 'cycling'){
        ...
        //Add new object to morkout array
